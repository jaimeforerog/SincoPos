...
const AuditoriaVentasPage = lazy(() => import('./features/ventas/pages/AuditoriaVentasPage').then(m => ({ default: m.AuditoriaVentasPage })));
      ...
      <Routes>
        ...
        >
          ...
          <Route path="reportes">
            ...
            <Route path="auditoria-ventas" element={<ProtectedRoute requiredRoles={['supervisor', 'admin']}><AuditoriaVentasPage /></ProtectedRoute>} />
