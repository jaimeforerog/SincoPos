...
const require_factory = require("./factory-DgWOj5Mq.cjs");
//#region src/index.ts
...
exports.CheckOp = require_factory.CheckOp;
...
exports.GeneratePortalLinkIntent = require_factory.GeneratePortalLinkIntent;
