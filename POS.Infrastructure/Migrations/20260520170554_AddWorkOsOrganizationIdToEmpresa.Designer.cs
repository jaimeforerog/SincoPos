...
namespace POS.Infrastructure.Migrations
{
    ...
    [Migration("20260520170554_AddWorkOsOrganizationIdToEmpresa")]
    partial class AddWorkOsOrganizationIdToEmpresa
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("POS.Infrastructure.Data.Entities.ActivityLogArchivo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("FechaArchivado")
                        .HasDatabaseName("idx_archivo_fecha_archivado");

                    b.HasIndex("FechaHora")
                        .HasDatabaseName("idx_archivo_fecha");

                    b.HasIndex("UsuarioEmail")
                        .HasDatabaseName("idx_archivo_usuario");

                    b.HasIndex("TipoEntidad", "EntidadId")
                        .HasDatabaseName("idx_archivo_entidad");

                    b.ToTable("activity_logs_archivo", "public");
                });
            ...
            modelBuilder.Entity("POS.Infrastructure.Data.Entities.ConfiguracionVariable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("configuracion_variables", "public");
                });
            ...
            modelBuilder.Entity("POS.Infrastructure.Data.Entities.DetalleDevolucionCompra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("detalle_devoluciones_compra", "public");
                });
            ...
            modelBuilder.Entity("POS.Infrastructure.Data.Entities.DevolucionCompra", b =>
                {
                    ...
                    b.HasIndex("NumeroDevolucion")
                        .IsUnique()
                        .HasDatabaseName("ix_devoluciones_compra_numero");

                    b.HasIndex("OrdenCompraId");

                    b.ToTable("devoluciones_compra", "public");
                });
            ...
            modelBuilder.Entity("POS.Infrastructure.Data.Entities.Empresa", b =>
                {
                    ...
                    b.Property<string>("WorkOsOrganizationId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("POS.Infrastructure.Data.Entities.OrdenCompra", b =>
                {
                    ...
                    b.HasIndex("SucursalId", "NumeroOrden")
                        .IsUnique()
            ...
            modelBuilder.Entity("POS.Infrastructure.Data.Entities.Producto", b =>
                {
                    ...
                    b.Property<decimal?>("CantidadMlPorUnidad")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("POS.Infrastructure.Data.Entities.TramoBebidasAzucaradas", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal?>("MaxGramosPor100ml")
                        .HasColumnType("numeric");

                    b.Property<decimal>("ValorPor100ml")
                        .HasColumnType("numeric");
                    ...
                    b.ToTable("TramosBebidasAzucaradas", "public");
                });
            ...
            modelBuilder.Entity("POS.Infrastructure.Data.Entities.DetalleDevolucionCompra", b =>
                {
                    b.HasOne("POS.Infrastructure.Data.Entities.DevolucionCompra", "DevolucionCompra")
                        .WithMany("Detalles")
